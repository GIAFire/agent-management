package com.zhiran.agent.knowledge.service;

import static com.zhiran.agent.knowledge.KnowledgeConstants.CHUNK_CHARACTER;
import static com.zhiran.agent.knowledge.KnowledgeConstants.CHUNK_DELIMITER;
import static com.zhiran.agent.knowledge.KnowledgeConstants.CHUNK_PARAGRAPH;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DEFAULT_CHUNK_OVERLAP;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DEFAULT_CHUNK_SIZE;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DELETING;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DISABLED;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_CHUNKING;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_DELETE_FAILED;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_DELETED;
...
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_FAILED;
...
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_PENDING;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_READY;
import static com.zhiran.agent.knowledge.KnowledgeConstants.DOCUMENT_UPLOADED;
import static com.zhiran.agent.knowledge.KnowledgeConstants.ENABLED;
import static com.zhiran.agent.knowledge.KnowledgeConstants.MAX_CHUNK_OVERLAP;
import static com.zhiran.agent.knowledge.KnowledgeConstants.MAX_CHUNK_SIZE;
import static com.zhiran.agent.knowledge.KnowledgeConstants.MAX_DELIMITER_LENGTH;
import static com.zhiran.agent.knowledge.KnowledgeConstants.MIN_CHUNK_SIZE;
import static com.zhiran.agent.knowledge.KnowledgeConstants.SUPPORTED_METRICS;
...
import com.zhiran.agent.constant.enumeration.ApiType;
import com.zhiran.agent.knowledge.KnowledgeOperationException;
import com.zhiran.agent.knowledge.dto.KnowledgeBaseCreateRequest;
import com.zhiran.agent.knowledge.dto.KnowledgeBaseOptionResponse;
import com.zhiran.agent.knowledge.dto.KnowledgeBaseResponse;
import com.zhiran.agent.knowledge.dto.KnowledgeBaseUpdateRequest;
...
import com.zhiran.agent.knowledge.dto.KnowledgeMetricsResponse;
import com.zhiran.agent.knowledge.processing.KnowledgeDocumentDispatcher;
import com.zhiran.agent.knowledge.processing.KnowledgeUploadValidator;
import com.zhiran.agent.knowledge.processing.KnowledgeUploadValidator.ValidatedUpload;
import com.zhiran.agent.knowledge.storage.KnowledgeSourceStorage;
import com.zhiran.agent.knowledge.storage.KnowledgeSourceStorage.StoredSource;
