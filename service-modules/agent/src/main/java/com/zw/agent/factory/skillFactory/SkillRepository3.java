...
public class SkillRepository3 implements AgentSkillRepository {
    private static final Logger logger = LoggerFactory.getLogger(SkillRepository3.class);
    ...
    private static final String DEFAULT_SKILLS_TABLE_NAME = "ai_skill_info";

    /** Default table name for storing skill resources. */
    private static final String DEFAULT_RESOURCES_TABLE_NAME = "ai_skill_file";
    ...
    /**
     * Create a SkillRepository with custom database name, table names, and
     * options.
     *
     * <p>
    ...
    SkillRepository3(
        ...
        logger.info(
                "SkillRepository initialized with database: {}, skills table: {},"
                        + " resources table: {}",
                this.databaseName,
                this.skillsTableName,
                this.resourcesTableName);
                ...
                if (!rs.next()) {
                    throw new IllegalStateException(
                            "Database does not exist: "
                                    + databaseName
                                    + ". Use SkillRepository(dataSource, true) to"
                                    + " auto-create.");
                }
            }
        } catch (SQLException e) {
    ...
    /**
     * Create a new Builder for SkillRepository.
     *
     * <p>
     * Example usage:
     *
     * <pre>{@code
     * SkillRepository repo = SkillRepository.builder(dataSource)
    ...
    /**
     * Builder for creating SkillRepository instances with custom configuration.
     *
     * <p>
    ...
    public static class Builder {
        ...
        /**
         * Build the SkillRepository instance.
         *
         * @return a new SkillRepository instance
         * @throws IllegalArgumentException if identifiers are invalid
         * @throws IllegalStateException    if createIfNotExist is false and
         *                                  database/tables do not exist
         */
        public SkillRepository3 build() {
            return new SkillRepository3(
                    dataSource,
                    databaseName,
                    skillsTableName,
                    resourcesTableName,
