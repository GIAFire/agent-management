...
public class AiAgentMessageEntity extends BaseEntity {
    ...
    /**
     * 消息类型：USER_TEXT、ASSISTANT_THINKING、ASSISTANT_TEXT、TOOL_CALL、TOOL_RESULT、SKILL_CALL、SKILL_RESULT、SUBAGENT_CALL、SUBAGENT_RESULT、PLAN_SNAPSHOT、PLAN_OPERATION、CONFIRM_REQUEST、CONFIRM_RESULT、EXTERNAL_EXECUTION_REQUEST、EXTERNAL_EXECUTION_RESULT、SYSTEM_NOTICE、ERROR
     */
