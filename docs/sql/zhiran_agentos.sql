...
CREATE TABLE `ai_agent_model`  (
  ...
  `provider_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '模型供应商显示名称',
...
CREATE TABLE `ai_model_call_log`  (
  ...
  `provider_name_snapshot` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '调用时的模型供应商快照',
