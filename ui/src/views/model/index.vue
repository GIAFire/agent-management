...
const filteredRows = computed(() => {
  ...
  return modelRows.value.filter((row) => {
    const matchKeyword = !keyword || [row.modelAlias, row.provider, row.modelName]
...
const handleDelete = async (row) => {
  try {
    await ElMessageBox.confirm(`确认删除模型配置「${row.modelAlias}」吗？`, '删除确认', {
      type: 'warning',
  ...
  <section class="resource-page">
    ...
    <div class="table-panel">
      ...
      >
        ...
        <el-table-column prop="modelAlias" label="模型别名" min-width="160" show-overflow-tooltip />
    ...
    >
      ...
      >
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="模型别名" prop="modelAlias">
              <el-input v-model="form.modelAlias" placeholder="如 qwen-plus-prod" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
